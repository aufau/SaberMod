...
g_utils g_weapon w_force w_saber q_math q_shared g_syscalls g_stats		\
g_dimensions
...
pk3assets := SOURCE.txt mv.info ui/jk2mp/menudef.h					\
...
ui/jk2mp/gameinfo.txt ui/jk2mp/setup.menu strip/SABERMOD_INGAME.sp	\
