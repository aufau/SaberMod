...
equ trap_MVAPI_SetVirtualScreen				-701	; CG_MVAPI_SETVIRTUALSCREEN
...
equ sinf									-104	; CGAME_SIN
equ cosf									-105	; CGAME_COS
equ atan2f									-106	; CGAME_ATAN2
equ sqrtf									-107	; CGAME_SQRT
...
equ floorf									-111	; CGAME_FLOOR
equ ceilf									-112	; CGAME_CEIL
equ acosf									-113	; CGAME_ACOS
equ asinf									-114	; CGAME_ASIN
