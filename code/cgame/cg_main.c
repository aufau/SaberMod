...
static cvarTable_t cvarTable[] = { // bk001129
	...
	{ &cg_drawTimer, "cg_drawTimer", "2", CVAR_ARCHIVE  },
	...
	{ &cg_centertime, "cg_centertime", STR(DEFAULT_CENTERTIME), CVAR_CHEAT },
...
void CG_RegisterCvars( void ) {
	...
	trap_Cvar_Register(NULL, "cg_fixServerTime", "1", CVAR_LATCH | CVAR_ARCHIVE );
	...
	trap_Cvar_Register(NULL, "ui_about_lifelimit",		"0", CVAR_ROM|CVAR_INTERNAL );
