...
void BG_PlayerStateToEntityState( playerState_t *ps, entityState_t *s, qboolean snap, qboolean extrapolate ) {
	...
	s->pos.trType = extrapolate ? TR_INTERPOLATE : TR_LINEAR_STOP;
...
#define PM_BACKPEDAL_PENALTY_STYLE 1
...
#if PM_BACKPEDAL_PENALTY_STYLE == 1
...
#elif PM_BACKPEDAL_PENALTY_STYLE == 2
...
#elif PM_BACKPEDAL_PENALTY_STYLE == 3
